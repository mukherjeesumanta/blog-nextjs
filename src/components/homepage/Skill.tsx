...
function Skill({ directionLeft }: Props) {
  return (
    <div className='group relative flex cursor-pointer'>
        ...
        className="rounded-full border border-gray-500 object-cover w-12 h-12 md:h-24 md:w-24 xl:h-28 xl:w-28 filter group-hover:grayscale transition duration-300 ease-in-out"
        />
